...
expression_map = {
    ...
    'sporophyte': 12,
    'shoot': 13,
    'sporeling at 24hr': 14,
    'sporeling at 48hr': 15,
    'shoot system': 16,
    'reproductive part': 17,
...
# Apply italics to both gene ID and species name
ax.set_yticklabels([r'$\it{{{}}}$'.format(species.replace('_', r'\_')) for species in heatmap_data.index],
...
plt.xlabel('Expression Rank of Third Paralog', fontsize=14, fontweight='bold', color='navy')
plt.ylabel(r'Species with $\mathbf{\it{MIZ1}}$ Gene Expression', fontsize=14, fontweight='bold', color='navy')
